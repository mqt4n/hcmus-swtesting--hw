...
Báo cáo này tổng hợp **20 lỗi phần mềm tiêu biểu** được công bố trong giai đoạn 2022–2026, bao gồm ít nhất **5 lỗi liên quan đến hệ thống Trí tuệ nhân tạo (AI) và Mô hình Ngôn ngữ Lớn (LLM)**, cụ thể là các hiện tượng: ảo giác (*hallucination*), tiêm mã độc vào prompt (*prompt injection*) và thiên kiến (*bias*). Mỗi lỗi được trình bày theo cấu trúc thống nhất gồm: nguồn tham khảo, mô tả sự kiện, mức độ nghiêm trọng, hậu quả thực tế và giải pháp khắc phục.
...
- [BBC Travel – Air Canada chatbot misinformation](https://www.bbc.com/travel/article/20240222-air-canada-chatbot-misinformation-what-travellers-should-know) *(truy cập với VPN)*
...
- [BBC News – Google AI Overviews errors](https://www.bbc.com/news/articles/cd11gzejgz4o) *(truy cập với VPN)*
...
Phán quyết trong vụ *Moffatt v. Air Canada* xác lập nguyên tắc pháp lý quan trọng: doanh nghiệp phải chịu trách nhiệm pháp lý cho toàn bộ thông tin do AI chatbot của họ cung cấp trên website, bất kể thông tin đó đúng hay sai.
...
Sự phụ thuộc quá mức vào Cloudflare, Azure, CrowdStrike, Okta và các nhà cung cấp tương tự đang tạo ra các điểm thất bại đơn lẻ (*single point of failure*) có khả năng gây gián đoạn toàn cầu — điển hình là sự cố Cloudflare làm sập đồng thời ChatGPT, Spotify và X, hay CrowdStrike làm tê liệt 8,5 triệu máy Windows chỉ trong vài giờ.
...
*Báo cáo được tổng hợp từ các nguồn công khai đáng tin cậy bao gồm: NVD (National Vulnerability Database), CISA, OWASP, OpenAI Blog, phán quyết tòa án, báo cáo sự cố chính thức của các tổ chức, và các ấn phẩm kỹ thuật uy tín. Thông tin được cập nhật đến tháng 6/2026.*
